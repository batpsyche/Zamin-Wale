...
import { getOneProperty, uploadPropertyImage } from "@/actions/property";
import { updatePropertyAdmin, deletePropertyAdmin } from "@/actions/admin";
...
const Page = () => {
    ...
    const onSubmit = async (values) => {
        ...
        try {
            const resp = await updatePropertyAdmin(propertyId, body);
            setLoading(false);
